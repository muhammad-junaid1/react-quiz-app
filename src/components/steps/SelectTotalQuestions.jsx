...
const SelectTotalQuestions = ({dispatch, ACTIONS}) => {
    ...
    return (
        <>
            ...
            <StyledTotalQuestionsRange value={value} onChange={handleChange} type="range" step="5" min="0" max="30"></StyledTotalQuestionsRange>
            <p><strong>{value}</strong> Questions</p>
            <StyledNextBtn style={{marginTop: 10}} disabled={!parseInt(value)} onClick={handleClickNext}>Next</StyledNextBtn>
        </>
    );
}
